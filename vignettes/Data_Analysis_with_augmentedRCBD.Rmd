...
- \setmonofont[Scale=MatchLowercase]{FreeMonoBold.otf}
- \setmonofont[Scale=0.9]{FreeMonoBold.otf}
link-citations: yes
csl: frontiers.csl
resource_files:
- vignettes/rbase.png
...
```{r, echo = FALSE, results='asis'}
switch(out_type,
    html = cat('<img src="https://github.com/aravind-j/augmentedRCBD/raw/master/vignettes/augRCBDexcel.png" align="center" alt="The `R` download location.">'),
    latex = cat('\\includegraphics{augRCBDexcel.png}'))
```

```{r, echo = FALSE, results='asis'}
switch(out_type,
    html = cat('<p style="text-align: left;"><strong>Fig. 6</strong>: MS Excel report generated with `report.agumentedRCBD` function.</p>'),
    latex = cat('\\begin{center}
                \\textbf{Fig. 7}: MS Excel report generated with \\texttt{report.agumentedRCBD} function.
                \\end{center}'))
```
...
```{r, echo = FALSE, results='asis'}
switch(out_type,
    html = cat('<p style="text-align: left;"><strong>Fig. 9</strong>: MS Word report generated with `report.agumentedRCBD.bulk` function.</p>'),
    latex = cat('\\begin{center}
                \\textbf{Fig. 9}: MS Word report generated with \\texttt{report.agumentedRCBD.bulk} function.
                \\end{center}'))
```
...
```{r, echo = FALSE, results='asis'}
switch(out_type,
    html = cat('<img src="https://github.com/aravind-j/augmentedRCBD/raw/master/vignettes/augRCBDbulkexcel.png" align="center" alt="The `R` download location.">'),
    latex = cat('\\includegraphics{augRCBDbulkexcel.png}'))
```

```{r, echo = FALSE, results='asis'}
switch(out_type,
    html = cat('<p style="text-align: left;"><strong>Fig. 10</strong>: MS Excel report generated with `report.agumentedRCBD.bulk` function.</p>'),
    latex = cat('\\begin{center}
                \\textbf{Fig. 10}: MS Excel report generated with \\texttt{report.agumentedRCBD.bulk} function.
                \\end{center}'))
```
